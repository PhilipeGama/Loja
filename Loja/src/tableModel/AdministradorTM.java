 ...
 */
public class AdministradorTM extends AbstractTableModel{

    private List<String[]> linhas;
    
    private String[] colunas = new String[]{"Id","Nome","Senha"};
    
    public AdministradorTM() {
        linhas = new ArrayList<String[]>();
    }
    
    public AdministradorTM(List<String[]> lista) {
