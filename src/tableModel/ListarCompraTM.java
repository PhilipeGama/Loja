 ...
 */
public class ListarCompraTM extends AbstractTableModel{

    private List<String[]> linhas;
    private String[] colunas = new String[]{"Id Compra","Id Cliente","Produto","Quatidande","Status"};
    
    public ListarCompraTM() {
        linhas = new ArrayList<String[]>();
    }
    
    public ListarCompraTM(List<String[]> lista) {
